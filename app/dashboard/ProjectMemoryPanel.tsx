      ...
      <aside className="fixed right-0 top-0 z-50 flex h-full w-full max-w-md flex-col border-l border-neutral-800 bg-neutral-900 shadow-2xl">
        ...
        >
          ...
          <button
            ...
            className="whitespace-nowrap rounded-lg bg-core-purple px-3 py-2 text-sm font-medium text-[#111214] hover:bg-core-purple disabled:cursor-not-allowed disabled:bg-neutral-800 disabled:text-neutral-500"
          >
              ...
              {editingKey === key ? (
                <div className="mt-2 flex gap-2">
                  ...
                  <button
                    ...
                    className="rounded bg-core-purple px-2 py-1 text-xs font-medium text-[#111214] hover:bg-core-purple"
                  >
                    Save
                  </button>
                </div>
