    ...
    <div className="mx-auto max-w-md rounded-xl border border-neutral-800 bg-neutral-900/60 p-6">
          ...
          <div key={label} className="flex flex-1 items-center gap-2">
            <div
              className={`flex h-6 w-6 shrink-0 items-center justify-center rounded-full text-xs font-medium ${
                i <= step ? "bg-core-purple text-[#111214]" : "bg-neutral-800 text-neutral-500"
              }`}
            >
              {i + 1}
            </div>
      ...
      <div className="mt-5 flex gap-2">
        ...
        <button
          ...
          className="ml-auto rounded-lg bg-core-purple px-4 py-2 text-sm font-medium text-[#111214] hover:bg-core-purple disabled:cursor-not-allowed disabled:opacity-60"
        >
