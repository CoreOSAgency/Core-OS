            ...
            <div key={s} className="flex flex-1 items-center gap-2">
              <div
                className={`flex h-6 w-6 shrink-0 items-center justify-center rounded-full text-xs font-medium ${
                  i <= step ? "bg-core-purple text-white" : "bg-white/5 text-neutral-500"
                }`}
              >
                {i + 1}
              </div>
        ...
        <div className="rounded-xl border border-white/10 bg-core-card p-6">
          ...
          <div className="mt-6 flex gap-2">
            ...
            <button
              ...
              className="ml-auto rounded-lg bg-core-purple px-4 py-2 text-sm font-medium text-white hover:bg-core-purple/80 disabled:cursor-not-allowed disabled:opacity-50"
            >
              {creating
                ? "Creating…"
                : step === STEPS.length - 1
